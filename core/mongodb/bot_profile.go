...
func CreateBotProfile(ctx context.Context, tenantID, name, persona string, connectorIDs, channels []string, rolesAllowed []databasev1.Role) (*databasev1.BotProfile, error) {
